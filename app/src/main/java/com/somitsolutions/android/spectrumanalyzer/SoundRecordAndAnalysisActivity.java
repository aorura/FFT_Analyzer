...
public class SoundRecordAndAnalysisActivity extends Activity implements OnClickListener {
    ...
    Paint paintSpectrumDisplay, paintSpectrumDisplay2;
    ...
    private class RecordAudio extends AsyncTask<Void, double[], Void> {
        ...
        protected void onProgressUpdate(double[]... toTransform) {
            ...
            Toast.makeText(getBaseContext(), "width: " + width, Toast.LENGTH_LONG).show();
            if (width > 512) {
                for (int i = 0; i < toTransform[0].length; i++) {
                    ...
                    if (i < toTransform[0].length / 3) {
                        canvasDisplaySpectrum.drawLine(x, downy, x, upy, paintSpectrumDisplay2);
                    } else {
    ...
    public void onStart() {
        ...
        paintSpectrumDisplay2 = new Paint();
        paintSpectrumDisplay.setColor(Color.GREEN);
        paintSpectrumDisplay2.setColor(Color.RED);
